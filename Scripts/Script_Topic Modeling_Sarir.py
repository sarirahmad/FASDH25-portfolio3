...
df_filtered.to_csv("Outputs/filtered_topic_data_Jun2023-Jan2024_Sarir.csv", index=False)

#After manually examining the topic themes I saw some were less important therefore, listing topic numbers to remove
...
print("Outputs are saved in the folder successfully")
